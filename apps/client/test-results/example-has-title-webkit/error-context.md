...
- main:
  - main:
    ...
    - text: Initializing Protocol 30% ✓ Smart Contracts Loaded ✓ Blockchain Connection Established ✓ DeFi Protocols Initialized ✓ NFT Marketplace Ready ✓ Welcome to Lendr
    - img
    - img
    - img
    - img
