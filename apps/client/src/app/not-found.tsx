          ...
          <div className='text-center max-w-4xl mx-auto'>
            ...
            <div className='mb-12'>
              ...
              <p className='text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed'>
                Looks like this digital asset has been transferred to another dimension. Don&apos;t worry, there are
                plenty more NFTs to discover in our marketplace!
              </p>
            </div>
          </div>
        </div>
          ...
          <motion.div
            ...
            {[
              ...
              <motion.div
                ...
                <stat.icon
                  className='mx-auto mb-2 text-lendr-400'
                  size={24}
                />
