...
import { CreateUserDto, UpdateUserDto, UserDto, ResponseDto } from '@repo/shared-dtos';
...
export class UsersService implements UsersServiceAbstractClass {
    ...
    async update(address: string, updateUserDto: UpdateUserDto): Promise<ResponseDto<UserDto>> {
        ...
        try {
            const user: User | null = await this.usersDbService.update(address, updateUserDto);
    ...
    async findOne(address: string): Promise<ResponseDto<UserDto>> {
        ...
        try {
            const user: User | null = await this.usersDbService.findOne(address);
