...
export abstract class RentalsServiceAbstractClass {
  abstract create(createRentalDto: CreateRentalDto): Promise<ResponseDto<RentalDto>>;

  abstract update(rentalId: number, updateRentalDto: UpdateRentalDto): Promise<ResponseDto<RentalDto>>;
