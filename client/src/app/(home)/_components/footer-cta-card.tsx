                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center pt-10 relative z-10">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <LendrButton size="lg" icon={<ArrowRight className="ml-2 w-5 h-5" />} className="bg-slate-950 hover:bg-slate-800 text-lendr-400 border-0 p-3 md:p-6.5 font-bold shadow-lg hover:shadow-xl transition-all duration-300 w-full">Explore Now</LendrButton>
                            <LendrButton size="lg" className="bg-slate-950 hover:bg-slate-800 text-lendr-400 border-0 p-3 md:p-6.5 font-bold shadow-lg hover:shadow-xl transition-all duration-300 w-full">List your first NFT</LendrButton>
                        </div>
                    </motion.div>
