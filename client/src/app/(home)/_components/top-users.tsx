        ...
        >
            ...
            <div className="relative">
                ...
                <motion.button
                    ...
                    className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full border-2 flex items-center justify-center transition-all duration-300 ${currentSlide === 0
                ...
                <motion.button
                    ...
                    className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full border-2 flex items-center justify-center transition-all duration-300 ${currentSlide >= maxSlide
                        ? "border-slate-600 text-slate-600 cursor-not-allowed"
                ...
                {/* Carousel Content */}
                <div className="overflow-hidden mx-16 py-20" onMouseEnter={() => setIsHovered(true)}
                                    ...
                                    >
                                        ...
                                        <div className="relative">
                                            <Avatar className="w-30 h-30 border-4 border-lendr-400/30 shadow-lg shadow-lendr-400/20">
                                                <AvatarImage src={lender.avatarUrl || "/placeholder.svg"} alt={lender.username} />
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        <motion.div
                                            ...
                                            style={{ width: `${(lender.reputationScore / 5) * 100}%` }}
                                            animate={{
                                                boxShadow: [
                                                    "0 0 5px rgba(220, 243, 71, 0.5)",
                ...
                <div className="flex justify-center mt-8 space-x-2">
                    {Array.from({ length: maxSlide + 1 }).map((_, index) => (
                        <motion.button
                            ...
                            className={`w-2 h-2 rounded-full transition-all duration-300 ${currentSlide === index ? "bg-lendr-400 w-8" : "bg-slate-600 hover:bg-slate-500"
                                }`}
