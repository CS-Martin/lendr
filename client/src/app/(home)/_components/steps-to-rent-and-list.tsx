            ...
            <motion.div
                ...
                <div className='mb-8'>
                    ...
                    <p className='text-slate-400 text-sm text-center md:text-left md:text-[16px] font-mono leading-relaxed'>
                        Our decentralized platform enables seamless NFT rentals
                        with advanced DeFi protocols, smart contract security,
                        and automated yield optimization for maximum returns.
                    </p>
                </div>
