...
const rentalPosts = [
    {
        ...
        description:
            'Rare legendary sword from popular RPG game with fire enchantment',
        hourlyRate: 0.002,
        collateral: 0.2,
        isBiddable: true,
    ...
    },
    {
        ...
        description:
            'Award-winning digital photography NFT with exclusive rights',
        hourlyRate: 0.0015,
        collateral: 0.25,
        isBiddable: true,
    ...
    },
    {
        ...
        description:
            'Customizable metaverse avatar with rare traits and accessories',
        hourlyRate: 0.0045,
        collateral: 0.6,
        isBiddable: true,
