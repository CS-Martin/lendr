            ...
            <div className='container mx-auto px-4 pb-7 pt-12 relative z-10 max-w-7xl'>
                <div className='grid grid-cols-1 md:grid-cols-4 gap-12'>
                    <motion.div
                        ...
                        <div className='flex items-center space-x-2 mb-6'>
                            ...
                            <h3 className='text-2xl font-bold text-lendr-400'>
                                Lendr
                            </h3>
                        </div>
                        <p className='text-slate-400 text-md leading-relaxed text-sm font-mono'>
                            The future of NFT utility through advanced DeFi
                            protocols and decentralized lending infrastructure.
                        </p>
                    </motion.div>
                ...
                <motion.div
                    ...
                    <p className='text-slate-400 text-sm'>
                        &copy; 2025 Lendr. All rights reserved. Built on
                        Ethereum with ❤️
                    </p>
                </motion.div>
            </div>
