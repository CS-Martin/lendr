        ...
        <motion.div
            ...
            <div className='text-center mb-16'>
                ...
                <p className='text-slate-400 text-[16px] md:text-lg md:max-w-3xl mx-auto'>
                    Discover our most successful lenders based on completed
                    transactions, reputation scores, and total earnings in the
                    Lendr ecosystem.
                </p>
            </div>
