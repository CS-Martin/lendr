                    ...
                    <div className='bg-yellow-900/20 border border-yellow-800 rounded-lg p-4'>
                        <div className='flex items-start space-x-3'>
                            ...
                            <div className='text-sm text-yellow-200'>
                                ...
                                <p>
                                    Completing the settlement will automatically return the NFT from the smart contract registry
                                    and distribute the rental fee. Make sure you have completed all necessary transactions on-chain.
                                </p>
                            </div>
                        </div>
                    </div>
