...
export function Step5Completed() {
    ...
    return (
        <div className='bg-green-900/20 border border-green-800 rounded-lg p-4'>
            ...
            <div className='text-sm text-green-200 mb-4'>
                The rental process has been completed successfully. All funds have been distributed.
            </div>

            <div className='space-y-3'>
                <div className='bg-slate-700/50 p-3 rounded-md'>
                    <h4 className='text-sm font-semibold text-white mb-2'>Final Settlement:</h4>
                ...
                <div className='bg-green-900/30 border border-green-700 p-3 rounded-md'>
                    <div className='flex items-center space-x-2 text-green-300 mb-1'>
                        <CheckCircle className='w-4 h-4' />
                        <span className='text-sm font-semibold'>Rental Complete</span>
                    </div>
                    <p className='text-xs text-green-200'>
                        The NFT rental has been completed successfully. Thank you for using Lendr!
                    </p>
                </div>
            </div>
        </div>
