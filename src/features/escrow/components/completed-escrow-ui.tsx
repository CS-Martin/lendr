                                    ...
                                    <div className='flex items-center justify-between'>
                                        ...
                                        {step.status === 'COMPLETED' && step.timestamp && (
                                            <span className='text-slate-400 text-sm'>
                                                {formatDistanceToNow(step.timestamp)} ago
                                            </span>
                                        )}
                                    </div>
                ...
                <CardContent className='p-4'>
                    <div className='flex items-start space-x-3'>
                        ...
                        <div className='text-sm text-blue-200'>
                            ...
                            <p>
                                This escrow was secured by smart contracts and all transactions are recorded on-chain.
                                You can verify the settlement by checking the transaction hash on a blockchain explorer.
                            </p>
                        </div>
                    </div>
                </CardContent>
