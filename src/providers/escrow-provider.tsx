...
interface EscrowLifecycleContextType {
    ...
    createEscrow: (args: { bidId: Id<'bids'>; rentalPostId: Id<'rentalposts'>; rentalPostRenterAddress: string; rentalPostOwnerAddress: string; }) => Promise<void>;
...
export const EscrowLifecycleProvider = ({ children }: { children: ReactNode }) => {
    ...
    const createEscrow = async (args: { bidId: Id<'bids'>; rentalPostId: Id<'rentalposts'>; rentalPostRenterAddress: string; rentalPostOwnerAddress: string; }) => {
        setIsLoading(true);
        try {
    ...
    return (
        <EscrowLifecycleContext.Provider value={value}>
            {children}
