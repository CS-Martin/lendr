...
export const ContractInfo = ({ nftMetadata }: { nftMetadata: NftMetadata }) => (
    <div>
        <DetailSection title="Contract Information" icon={Link} iconColor="text-green-400">
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div className='flex items-center gap-1'>
                            <code className='text-xs text-gray-300'>
                                {truncateText(nftMetadata.contract.contractDeployer, 6, 4)}
                            </code>
                            <Button
                                size='sm'
                                variant='ghost'
                                ...
                                onClick={() =>
                                    window.open(
                                        `https://etherscan.io/address/${nftMetadata.contract.contractDeployer}`,
                                        '_blank',
                                    )
                                }
                            >
